...
let services = [
  {
    id: 1,
    title: "جرم‌گیری دندان",
    titleEn: "Dental scaling",
    description:
      "وجود جرم در دهان می‌تواند باعث به وجود آمدن عفونت در دندان‌ها یا بافت لثه شود. زمانی که دندان جرم می‌گیرد باید آن را از بین برد تا آسیب جدی‌تری به دهان، دندان و لثه ورد نکند. افرادی که به طور مرتب از نخ دندان و مسواک استفاده نمی‌کنند نیاز دارند تا حداقل سالی یک بار دندان‌های خود را جرم گیری کنند. در کلینیک دندانپزشکی سعادت آباد خدمات جرم گیری دندان توسط متخصص آن انجام می‌شود. برای گرفتن نوبت می‌توانید از طریق سایت اقدام کنید.",
    descriptionEn:
  ...
  },
  {
    ...
    titleEn: "Composite",
    description:
      "داشتن لبخندی زیبا برای تمامی افراد مهم است. گاهی دندان دچار مشکلاتی مانند شکستگی یا بد رنگی می‌شود که می‌تواند بسیار آزار دهنده باشد. امروزه روش‌های زیادی برای انجام کارهای زیبایی بر روی دندان‌ها وجود دارد. یکی از این روش‌ها کامپوزیت است. کامپوزیت، ماده‌ای خمیری شکل است که برای برطرف کردن نقص‌های دندان از آن استفاده می‌شود. کامپوزیت‌ها نیازی به قالب‌گیری ندارند. این مواد توسط دندانپزشک متخصص، روی دندان‌ها قرار می‌گیرد و به آن فرم داده می‌شود تا مشکلات دندان‌ها را بپوشاند. شما می‌توانید با مراجعه به کلینیک دندان پزشکی سعادت‌آباد، توسط پزشکان ما چک آپ شوید و در صورت نیاز، برای انجام خدمات نوبت بگیرید. خدمات کامپوزیت در هر روز، تنها برای یک نفر در کلینیک ما انجام می‌شود و ۴ الی ۵ ساعت زمان می‌برد.",
    descriptionEn:
  ...
  },
  {
    ...
    titleEn: "Implant",
    description:
      "دندان‌ها می‌توانند به دلایل متعددی مانند کشیدن یا پیری از بین بروند. برای جایگزین کردن آن‌ها، ایمپلنت روش بسیار موثری خواهد بود. ایمپلنت، پایه‌ای از جنس تیتانیوم است که درون لثه یا استخوان قرار گرفته و دندان مصنوعی روی آن قرار می‌گیرد. ابتدا لازم است دندان‌هایتان توسط دندانپزشکان کلینیک ما چک شده و نوبت دهی شود تا برای مراحل بعدی به کلینیک مراجعه کنید. در کلینیک دندانپزشکی سعادت آباد، ایمپلنت یک ساعته انجام می‌شود. برای گرفتن وقت اولیه می‌توانید با شماره‌های ما در ارتباط باشید. ",
    descriptionEn:
...
/*   {
  ...
  },
  {
    id: 12,
    title: "ترمیم پوسیدگی",
    titleEn: "Caries repair",
    description:
      "پوسیدگی دندان‌ها یکی از مشکلاتی است که ممکن است برای هر فردی اتفاق افتد. پوسیدگی دندان می‌تواند دلایل مختلفی داشته باشد. عدم رعایت بهداشت دهان و دندان و جنس دندان‌ها نیز بر پوسیدگی دندان تاثیرگذارند. زمانی که پوسیدگی به مینای دندان برسد، باید ترمیم شود. به این صورت که ابتدا بخش پوسیده شده توسط دندانپزشک متخصص خالی می‌شود، سپس با آمالگام که ماده‌ای از جنس نقره، قلع، روی، مس و جیوه است، جای خالی دندان پر می‌شود. برای انجام خدمات پوسیدگی دندان‌هایتان توسط پزشک متخصص کلینیک دندانپزشکی سعادت آباد می‌توانید از طریق سایت، نوبت گرفته و در زمان تایین شده به کلینیک مراجعه کنید.",
    descriptionEn:
  ...
  },
  {
    ...
    description:
        "دندان‌های عقل بین ۱۷ تا ۲۵ سالگی ظاهر می‌شوند. ممکن است در بعضی افراد هرگز دندان عقلی در نیاید. چهار دندان عقل، در گوشه‌ها و قسمت بالا و پایین عقب دهان قرار دارند. زمانی که دندان عقل فضایی برای رشد نداشته باشد، باعث بروز درد، عفونت و مشکلاتی شبیه به آن می‌شود. در چنین شرایطی، کشیدن دندان‌های عقل امری واجب است. دندان عقل می‌تواند نهفته باشد که مشکلاتی مانند درد، پوسیدگی و عفونت ایجاد می‌کنند. خدمات کشیدن دندان عقل در کلینیک دندانپزشکی سعادت آباد توسط دندانپزشک متخصص انجام می‌شود. برای گرفتن نوبت می‌توانید از طریق همین سایت اقدام کنید.",
    descriptionEn:
  ...
  {
    id: 14,
    title: "کشیدن ریشه دندان",
    titleEn: "Root extraction",
    description:
    "زمانی که ریشه دندان خراب و پوسیده می‌شود باید آن را کشید. برای انجام خدمات ایمپلنت نیز ابتدا لازم است تا ریشه دندان اصلی خارج شود، سپس خدمات ایمپلنت برای مراجع انجام شود. لازم است تا به پزشک متخصص مراجعه کنید تا پس از معاینه، خدمات کشیدن ریشه دندان شما آغاز شود. برای گرفتن نوبت از کلینیک دندانپزشکی سعادت آباد، می‌توانید از طریق سایت اقدام کنید.",
    descriptionEn:
